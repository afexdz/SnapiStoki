    ...
    return (
      <div className="bg-[var(--white)] rounded-2xl border border-[var(--orange)]/30 p-5 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="p-3 bg-gray-50 dark:bg-[var(--white)] rounded-xl text-center">
            <p className="text-lg font-black text-[var(--ink)]">{isFree ? "Gratuit" : `${price.toLocaleString("fr-DZ")}`}</p>
      ...
      <div>
        {isFree ? (
          ...
          <>
            ...
            <p className="text-2xl font-bold text-[var(--ink)]">{price.toLocaleString("fr-DZ")} <span className="text-base text-[var(--orange)]">DA</span></p>
          </>
        )}
      </div>
