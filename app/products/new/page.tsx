        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-[#EEEEEE] p-6">
              ...
              {!productFile ? (
                ...
                >
                  ...
                  <p className="text-sm text-gray-500">Glissez votre fichier ici ou <span className="text-[#FA8112] font-semibold">cliquez</span></p>
                ...
                <div className="grid grid-cols-4 gap-3">
                  {previews.map((p, i) => (
                    <div key={i} className="relative aspect-video bg-gray-100 rounded-lg overflow-hidden">
                      ...
                      {i === 0 && <span className="absolute bottom-1 left-1 px-1 py-0.5 bg-[#FA8112] text-white text-[8px] font-bold rounded">Cover</span>}
                    </div>
                  ))}
                </div>
              )}
            ...
            <button
              ...
              className="w-full py-3.5 bg-[#FA8112] text-white text-sm font-bold rounded-xl hover:bg-[#E8730F] transition-colors disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
