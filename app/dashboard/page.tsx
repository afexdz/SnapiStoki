...
export default async function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#1a1a1a]">
      {/* Top bar */}
      <header className="bg-white dark:bg-[#2a2a2a] border-b border-[#F0E8E0] dark:border-[#3a3a3a] px-6 py-4 flex items-center justify-between">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        {/* Welcome card */}
        <div className="bg-white dark:bg-[#2a2a2a] rounded-3xl border border-[#F0E8E0] dark:border-[#3a3a3a] p-8 mb-6 shadow-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-black text-[#1A1A1A] dark:text-[#FAF3E1] tracking-tight">
                Bonjour, {displayName} 👋
              </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={stat.label} className="bg-[#FFF8F0] dark:bg-[#3a3a3a] rounded-2xl p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/freelance" className="group bg-white dark:bg-[#2a2a2a] rounded-2xl border border-[#F0E8E0] dark:border-[#3a3a3a] p-6 shadow-sm hover:border-[#FA8112]/30 dark:hover:border-[#FA8112]/30 hover:shadow-md transition-all">
            ...
            <h3 className="font-bold text-[#1A1A1A] dark:text-[#FAF3E1] mb-1">Explorer les freelances</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Trouvez le talent parfait pour votre projet</p>
          </Link>
          <Link href="/marketplace" className="group bg-white dark:bg-[#2a2a2a] rounded-2xl border border-[#F0E8E0] dark:border-[#3a3a3a] p-6 shadow-sm hover:border-[#FA8112]/30 dark:hover:border-[#FA8112]/30 hover:shadow-md transition-all">
            <div className="w-10 h-10 rounded-xl bg-[#FA8112]/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <svg className="w-5 h-5 text-[#FA8112]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
              </svg>
            </div>
            <h3 className="font-bold text-[#1A1A1A] dark:text-[#FAF3E1] mb-1">Parcourir la marketplace</h3>
