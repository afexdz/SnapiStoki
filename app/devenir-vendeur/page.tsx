...
const benefits = [
  ...
  },
  {
    ...
    desc: "Accédez à une clientèle nationale — particuliers et entreprises à travers toute l'Algérie.",
  },
]
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-[#FA8112] to-[#E8730F] py-20 px-4">
          ...
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/80 text-lg max-w-xl mx-auto">
              Transformez votre talent en revenus. Rejoignez des milliers de freelances algériens sur la plateforme numérique n°1 en Algérie.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
            {benefits.map((b) => (
              <div
                key={b.title}
                className="bg-white dark:bg-[#2a2a2a] rounded-2xl border border-[#F0E8E0] dark:border-[#3a3a3a] p-6 shadow-sm hover:shadow-md hover:border-[#FA8112]/30 transition-all"
              >
          ...
          {/* CTA card */}
          <div className="bg-white dark:bg-[#2a2a2a] rounded-3xl border border-[#F0E8E0] dark:border-[#3a3a3a] shadow-xl shadow-[#FA8112]/5 p-8 sm:p-10 text-center max-w-lg mx-auto">
            ...
            <div className="mt-6 pt-6 border-t border-[#F0E8E0] dark:border-[#3a3a3a]">
              <Link
                href="/dashboard"
