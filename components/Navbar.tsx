          ...
          <div className="flex items-center gap-2">
            ...
            {user ? (
              <div className="relative" ref={dropdownRef}>
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 top-full mt-2 w-52 bg-[var(--white)] dark:bg-[var(--white)] rounded-2xl border border-[rgba(26,26,26,0.12)] dark:border-[var(--border-subtle)] shadow-xl shadow-gray-200/60 dark:shadow-black/40 py-1.5 z-50">
                    <div className="px-4 py-2.5 border-b border-[var(--border-subtle)] dark:border-[var(--border-subtle)]">
