const steps = [
  {
    ...
    color: "bg-[#FA8112]/10 dark:bg-[#FA8112]/20 text-[#FA8112]",
    accent: "border-[#FA8112]/30 dark:border-[#FA8112]/40",
  },
  {
    number: "02",
    title: "Commande",
    ...
    <section className="py-20 bg-[#FAF3E1] dark:bg-[#1a1a1a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-10 left-1/3 right-1/3 h-0.5 bg-gradient-to-r from-[#FA8112]/30 via-amber-200 to-emerald-200 dark:from-[#FA8112]/40 dark:via-amber-800 dark:to-emerald-800 -translate-y-1/2 z-0" />
        ...
        <div className="mt-14 text-center">
          <a
            href="#"
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#FA8112] hover:bg-[#E8730F] text-white font-semibold rounded-xl shadow-lg shadow-[#FA8112]/30 dark:shadow-[#FA8112]/20 transition-all hover:-translate-y-0.5 active:translate-y-0"
          >
