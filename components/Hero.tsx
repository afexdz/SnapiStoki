        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-14 items-center">
          ...
          <div>
            ...
            >
              ...
              <span className="relative inline-block" style={{ whiteSpace: "nowrap" }}>
                <span style={{ color: "var(--orange)" }}>{t("headlineHighlight")}</span>
                <svg
                  aria-hidden="true"
                  viewBox="0 0 200 12"
            ...
            >
              ...
              <button
                ...
                style={{ background: "var(--orange)", boxShadow: "0 4px 12px rgba(250,129,18,0.28)" }}
            ...
            <div className="flex items-center gap-2.5 mb-8 overflow-x-auto scrollbar-hide pb-1">
              <span className="text-[13px] shrink-0" style={{ color: "var(--ink-60)" }}>{t("popular")}</span>
              {chips.map((chip) => (
                <button
                  key={chip}
                  type="button"
                  ...
                  style={{ background: "var(--white)", border: "1px solid var(--ink-12)", color: "var(--ink)" }}
                >
                  {chip}
                </button>
              ))}
              ...
              <div className="flex flex-wrap gap-9">
                {servicesCount > 0 && (
                  <div>
                    ...
                    <span className="text-[13.5px]" style={{ color: "var(--ink-60)" }}>{t("statsServices")}</span>
                  </div>
                )}
                {profilesCount > 0 && (
                  <div>
                    ...
                    <span className="text-[13.5px]" style={{ color: "var(--ink-60)" }}>{t("statsFreelances")}</span>
                  </div>
                )}
              </div>
            )}
          ...
          <div className="hidden lg:block">
            <div className="relative" style={{ height: "440px" }}>
              ...
              <div className="absolute z-[4]" style={{ top: "110px", right: "18%" }}>
                <div
                ...
                >
                  <span className="w-2 h-2 rounded-full bg-[#3ECF6A] shrink-0" style={{ animation: "pulse 1.8s infinite" }} />
                  {t("deliveryBadge")}
                </div>
              </div>

              <div className="absolute animate-float-card" style={{ top: 0, left: "12%", transform: "rotate(-3deg)", zIndex: 3 }}>
                <MiniServiceCard
              ...
              <div className="absolute animate-float-card-2" style={{ top: "150px", right: 0, transform: "rotate(2.5deg)", zIndex: 2 }}>
                <MiniServiceCard
                  thumbBg="bg-[var(--ink)]"
                  thumbContent={
              ...
              <div className="absolute animate-float-card-3" style={{ bottom: 0, left: 0, transform: "rotate(-1.5deg)", zIndex: 1 }}>
                <MiniServiceCard
